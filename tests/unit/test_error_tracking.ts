...
describe('ErrorTracker', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    // Importar após mock
    const { errorTracker: tracker } = require('../../app/utils/error-tracking');
  ...
  describe('addBreadcrumb', () => {
    it('deve adicionar breadcrumb', () => {
      ...
      errorTracker.addBreadcrumb('Test breadcrumb', 'test-category', { test: 'data' });
  ...
  describe('Funções utilitárias', () => {
    ...
    it('captureMessage deve chamar errorTracker', () => {
      ...
      const { captureMessage } = require('../../app/utils/error-tracking');
